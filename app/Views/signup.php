...
<div id="mc_embed_signup" class=" two pb-3">
    ...
    <form action="https://gettonote.us6.list-manage.com/subscribe/post?u=1fcb3478dbbbc99c55e271755&amp;id=598491e9e5"
        ...
        <div id="mc_embed_signup_scroll">
            ...
            <input type="hidden" name="group[54042]" class="REQ_CSS" id="mce-group[54042]"
                   value="2">
            <label for="mce-MMERGE6">Do you have a Traditional Notary Certificate? </label>
            <div class="mc-field-group form-group">
                <select name="MMERGE3" class="required form-control" id="mce-MMERGE6">
                    <!--                                    <option value=""></option>-->
            ...
            <div style="position: absolute; left: -5000px;" aria-hidden="true">
                <input type="text" name="b_1fcb3478dbbbc99c55e271755_598491e9e5" tabindex="-1"
                       value="">
            </div>
